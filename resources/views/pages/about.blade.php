  ...
  <div class="detail-section">
    ...
    <div class="detail-team">
      <div class="team-card">
        ...
        <div class="team-info">
          <p class="team-name">ก้องภพ วิชัยดิษฐ</p>
      ...
      <div class="team-card">
        ...
        <div class="team-info">
          <p class="team-name">พิชามญชุ์ ศรีโสภา</p>
          <p class="team-role">Head of UX</p>
        </div>
      </div>
      <div class="team-card">
        <div class="team-avatar">
        ...
        <div class="team-info">
          <p class="team-name">ณัฐวุฒิ ทองประสาน</p>
      ...
      <div class="team-card">
        ...
        <div class="team-info">
          <p class="team-name">ชนิกานต์ รัตนมงคล</p>
          <p class="team-role">Strategy Director</p>
        </div>
      </div>
    </div>
  </div>
